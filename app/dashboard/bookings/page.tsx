  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Daftar Booking Jamaah</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-amber-200/60 bg-amber-50/20 shadow-xs space-y-1">
          ...
          <div className="text-xl sm:text-2xl font-bold text-amber-700">{pendingBookings}</div>
          <p className="text-[11px] text-amber-600/80">Status pending</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-emerald-200/60 bg-emerald-50/20 shadow-xs space-y-1">
          ...
          <div className="text-xl sm:text-2xl font-bold text-emerald-700">{paidBookings}</div>
          <p className="text-[11px] text-emerald-600/80">Pembayaran terverifikasi</p>
        </div>
