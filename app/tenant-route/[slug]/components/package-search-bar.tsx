        ...
        <div className={`sm:col-span-12 ${months.length > 0 ? 'lg:col-span-6' : 'lg:col-span-9'}`}>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 sm:py-3 bg-stone-50 border border-stone-200 rounded-lg sm:rounded-xl text-xs sm:text-sm text-site-text placeholder:text-stone-400 focus:outline-hidden focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 focus:bg-white transition-all font-sans"
            />
          </div>
        </div>
